...
public class LibrarySystemApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ImageView imageView = new ImageView(new Image("https://www.umm.ac.id/files/file/logo%20umm%20monocrom%20putim%20(1).png"));
        ...
        VBox mainMenu = new VBox(10,imageView,titleLabel, studentButton, adminButton, exitButton);
    ...
    private void showAdminLogin(Stage stage) {
        ...
        HBox loginMenu = new HBox(10, userLabel, userField, passLabel, passField, loginButton, backButton);
        loginMenu.setAlignment(Pos.CENTER);
        Scene loginScene = new Scene(loginMenu, 380, 500);
        stage.setScene(loginScene);
    }
